...
fprintf(fileID,'extern int count_ms;\nextern int count_nonms;\n#define ms_max_chl_num %d\nextern int ms_chl_num[msall_num];\nextern double ms_chl_con[msall_num];\n#define nonms_num %d\n\n',max(count_mschl),count_nscell);
fprintf(fileID,'extern Object *p_cell_ms[msall_num];\nextern Object *p_chl_ms[msall_num][ms_max_chl_num];\nextern Object *p_vac_ms[msall_num];\nextern Object *p_leaf;\nextern Object *p_cell_ns[nonms_num];\n\n');
